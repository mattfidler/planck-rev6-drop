...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_J] = ACTION_TAP_DANCE_DOUBLE(KC_J, KC_LGUI),
    [TD_K] = ACTION_TAP_DANCE_DOUBLE(KC_K, KC_APPLICATION),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 //,---------------------------------------.                       ,---------------------------------------.
       KC_Q,   KC_W,   LT_F,   LT_P,   KC_G,                           D_J,   LT_L,   LT_U,   KC_Y,  Q_QUO,
 //|-------+-------+-------+-------+-------|                       |-------+-------+-------+-------+-------|
        Q_A,    Q_R,    Q_S,    Q_T,   KC_D,                           KC_H,    Q_N,    Q_E,    Q_I,    Q_O,
 //|-------+-------+-------+-------+-------|                       |-------+-------+-------+-------+-------|
       KC_Z,    Q_X,   KC_C,    D_V,   KC_B,                            D_K,   LT_M,  Q_CMA,  Q_DOT,Q_SLASH,
 //|-------+-------+-------+-------+-------+-------|       |-------+-------+-------+-------+-------+-------|
